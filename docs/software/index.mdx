...
<div className="category-carousel">
  <Link to="/docs/software/setup" className="carousel-card">
  ...
  <Link to="/docs/software/vision-pipeline" className="carousel-card">
    <div className="carousel-icon">
  ...
  <Link to="/docs/software/automation" className="carousel-card">
    <div className="carousel-icon">
