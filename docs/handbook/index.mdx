...
<div className="category-carousel">
  <Link to="/docs/handbook/about-us" className="carousel-card">
  ...
  <Link to="/docs/handbook/event-procedures" className="carousel-card">
    <div className="carousel-icon">
  ...
  <Link to="/docs/handbook/team-information" className="carousel-card">
    <div className="carousel-icon">
